...
| Metric | Value |
|-|-|
| cardData.js lines | ~2200 (reformatted, grouped by type) |
| rarityColors.js lines | ~10 |
| Test files | src/data/__tests__/cardData.test.js (533 tests) |
| Data bugs fixed | 3 (CARD032 casing, Raise_the_Alarm type, CARD037 value) |
