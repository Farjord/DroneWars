...
const calculatePotentialEffectiveStats = (drone, lane, playerState, opponentState, allPlacedSections, getShipStatus) => {
...
const calculateLaneScore = (laneId, aiPlayerState, humanPlayerState, aiPlacedSections, humanPlacedSections, getShipStatus, calculateEffectiveStats) => {
  ...
  const getPower = (drones, owner, opponent, sections) => drones.reduce((sum, drone) => {
    ...
    const stats = isAI 
      ? calculatePotentialEffectiveStats(drone, laneId, owner, opponent, sections, getShipStatus)
...
const handleOpponentTurn = ({ player1, player2, passInfo, turn, opponentPlacedSections, placedSections, getShipStatus, calculateEffectiveShipStats, calculateEffectiveStats, addLogEntry }) => {
...
const currentLaneScores = {
  lane1: calculateLaneScore('lane1', player2, player1, opponentPlacedSections, placedSections, getShipStatus, calculateEffectiveStats),
  lane2: calculateLaneScore('lane2', player2, player1, opponentPlacedSections, placedSections, getShipStatus, calculateEffectiveStats),
  lane3: calculateLaneScore('lane3', player2, player1, opponentPlacedSections, placedSections, getShipStatus, calculateEffectiveStats),
};
...
const handleOpponentAction = ({ player1, player2, passInfo, placedSections, opponentPlacedSections, getShipStatus, getLaneOfDrone, calculateEffectiveStats, getValidTargets, addLogEntry }) => {
