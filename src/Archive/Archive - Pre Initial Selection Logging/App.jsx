...
{ 
  ...
  { name: 'Kamikaze Drone', class: 2, limit: 1, attack: 4, hull: 1, shields: 0, speed: 4, image: 'https://placehold.co/128x128/f80/000?text=Kamikaze', abilities: [] },
 ...
 setModalContent({
   ...
   const handleDeckChoice = (choice) => {
    if (choice === 'standard') {
      ...
      setModalContent({
        ...
        text: 'Now, place your ship sections. The sections must be placed in order: Bridge, then Power Cell, then Drone Control Hub.',
        isBlocking: true,
      });
  ...
  const handleConfirmDeck = () => {
    ...
    setModalContent({
      ...
      text: 'Your custom deck is ready. Now, place your ship sections to begin.',
      isBlocking: true,
    });
  };
