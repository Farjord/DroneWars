...
const endTurn = useCallback((actingPlayer) => {
  ...
  if (nextPlayerHasPassed) {
      // If the opponent has passed, it's just your turn again instantly. No modal needed.
  ...
  if (nextPlayer === 'player1') {
      // This clears the "Opponent's Turn" modal when the turn switches back to you.
      setModalContent(null);
  } else {
      // This non-blocking modal for the AI's turn can remain.
      setModalContent({ 
        title: "Opponent's Turn", 
        text: "The AI is taking its turn.", 
        isBlocking: false,
        onClose: null // This prevents the 'X' close button from appearing
      });
  }
}, [endActionPhase]);
            ...
            // --- [START] NEWLY ADDED CODE ---
              ...
              if (card.targeting?.type === 'LANE') {
                  ...
                  if (mod.stat === 'attack' && mod.value > 0) { // Attack Buff
                      ...
                      if (target.isExhausted) {
                          score = -1; // A pointless move gets a negative score.
