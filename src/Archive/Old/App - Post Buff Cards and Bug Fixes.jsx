...
// Piercing Attack Card
  ...
  },
   {
    ...
    description: 'Give a friendly drone +2 attack until the end of the turn. Go again.',
    targeting: {
      type: 'DRONE',
      affinity: 'FRIENDLY',
      location: 'ANY_LANE'
...
const aiPersonalities = [
  {
    ...
    { id: 'CARD014', quantity: 2 }, // Overcharge
    { id: 'CARD015', quantity: 2 }, // Streamline
    { id: 'CARD016', quantity: 2 }, // Static Field
    { id: 'CARD017', quantity: 2 }, // Boosters
    ]
  },
...
const startingDecklist = [
    ...
    { id: 'CARD014', quantity: 5 }, // Overcharge
    { id: 'CARD015', quantity: 5 }, // Streamline
    { id: 'CARD016', quantity: 5 }, // Static Field
    { id: 'CARD017', quantity: 5 }, // Boosters
];
...
useEffect(() => {
    if (selectedDrone && hoveredTarget && hoveredTarget.lane) {
        // We need the selected drone's effective stats too
        const selectedDroneLane = getLaneOfDrone(selectedDrone.id, player1);
        const effectiveAttacker = calculateEffectiveStats(selectedDrone, selectedDroneLane, player1, player2, placedSections);
        
        const potential = player2.dronesOnBoard[hoveredTarget.lane]
            .filter(d => {
                const effectiveInterceptor = calculateEffectiveStats(d, hoveredTarget.lane, player2, player1, opponentPlacedSections);
