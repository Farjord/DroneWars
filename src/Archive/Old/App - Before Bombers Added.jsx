...
const fullDroneCollection = [
  ...
  { name: 'Stealth Bomber', class: 3, limit: 1, attack: 5, hull: 2, shields: 1, speed: 4, image: 'https://placehold.co/128x128/f00/fff?text=Stealth', abilities: [] },
  { 
    name: 'Repair Drone', 
      ...
      switch (action.type) {
        ...
        case 'attack':
          ...
          if (targetType === 'drone') {
            ...
            // Priority: Damaging the Player's Ship
