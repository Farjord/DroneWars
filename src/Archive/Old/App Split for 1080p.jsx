...
const App = () => {
  ...
  const DroneCard = ({ drone, onClick, isSelectable, isSelected, deployedCount, ignoreDeployLimit = false }) => {
    ...
    return (
       <div
        ...
        className={`
          w-48 h-[300px] rounded-lg p-[2px] relative group
      ...
      >
        ...
        >
          ...
          {/* Image */}
          <div className="p-2 flex-shrink-0 h-24">
          ...
          {/* Stats */}
           <div className="flex flex-col gap-2 px-3 flex-shrink-0 h-[60px]">
          ...
          {/* Footer */}
           <div className="flex items-center justify-between p-2 border-t border-cyan-800/70 flex-shrink-0 h-14">
                <div className="flex flex-col items-center">
  ...
  return (
    <div className="h-screen bg-gray-950 text-white font-sans p-8 flex flex-col items-center bg-gradient-to-br from-gray-900 via-indigo-950 to-black relative" ref={gameAreaRef} onClick={cancelAbilityMode}>
      <style>
        {`
        ...
        <>
          {turnPhase === 'placement' ? (
           ...
           <DroneSelectionScreen 
            ...
            <>
                <div className="flex-grow w-full flex flex-col items-center overflow-y-auto px-4">
                  {/* --- BATTLEFIELD START --- */}
              ...
              <footer className="w-full mt-4 max-w-7xl flex flex-col items-center flex-shrink-0">
