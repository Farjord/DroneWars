...
[]);
  ...
  const [upgradeDestroySelection, setUpgradeDestroySelection] = useState(null); // For targeting specific upgrades to destroy
  ...
  const calculateEffectiveStats = useCallback((drone, lane, playerState, opponentState, allPlacedSections) => {
    ...
    // --- NEW: Apply global upgrades first ---
    ...
    let effectiveStats = {
      ...drone,
      attack: baseAttack, // Use the upgraded base stat
      speed: baseSpeed,   // Use the upgraded base stat
