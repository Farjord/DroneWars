...
const calculateEffectiveShipStats = (playerState, placedSections = []) => {
    ...
    return {
      totals: {
        handLimit: sectionStats.bridge?.['Draw'] || 0,
        discardLimit: sectionStats.bridge?.['Discard'] || 0,
        energyPerTurn: sectionStats.powerCell?.['Energy Per Turn'] || 0,
        maxEnergy: sectionStats.powerCell?.['Max Energy'] || 0,
        shieldsPerTurn: sectionStats.powerCell?.['Shields Per Turn'] || 0,
        initialDeployment: sectionStats.droneControlHub?.['Initial Deployment'] || 0,
        deploymentBudget: sectionStats.droneControlHub?.['Deployment Budget'] || 0,
        cpuLimit: sectionStats.droneControlHub?.['CPU Control Value'] || 0,
      },
