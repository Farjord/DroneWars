...
// ========================================
// Displays a warning overlay when a player hovers over an unplayable card
// Shows specific reasons why the card cannot be played
// Stays visible until unmounted (dismissal controlled by parent via mouse leave)
 ...
 */
const CardWarningOverlay = ({ reasons }) => {
