      ...
      <div className="hud-bottom">
        <div className="hud-actions-group">
          ...
          <button
            ...
            className="dw-btn-hud dw-btn-hud-cyan flex items-center gap-2"
          ...
          {atExtractionGate ? (
            <button
              ...
              className="dw-btn-hud dw-btn-hud-green flex items-center gap-2"
            ...
            <button
              ...
              className="dw-btn-hud flex items-center gap-2"
