...
// Drone action announcements
export const DRONE_ATTACK_ANNOUNCEMENT = 'DRONE_ATTACK_ANNOUNCEMENT';
export const DRONE_MOVE_ANNOUNCEMENT = 'DRONE_MOVE_ANNOUNCEMENT';
