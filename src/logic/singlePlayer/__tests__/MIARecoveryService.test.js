    ...
    it('calculates 50% of total card replication value for non-starter cards', () => {
      ...
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          decklist: [
            { id: 'OUT_THINK', quantity: 10 } // Common card (non-starter)
          ],
          droneSlots: [],
          shipComponents: {}
        }]
    ...
    it('applies floor when calculated cost is below minimum', () => {
      ...
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          shipId: starterPoolShipIds[0],
          decklist: [
            { id: 'CONVERGENCE_BEAM', quantity: 1 } // 1 Common = 1000 × 0.5 = 500
          ],
          droneSlots: [],
          shipComponents: {}
        }]
    ...
    it('correctly sums mixed rarity cards', () => {
      ...
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          shipId: starterPoolShipIds[0],
          decklist: [
            { id: 'OUT_THINK', quantity: 10 }, // Common (non-starter): 10 × 1000 = 10,000
            { id: 'CONVERGENCE_BEAM_ENHANCED', quantity: 5 }, // Uncommon: 5 × 2500 = 12,500
            { id: 'PIERCING_ROUNDS', quantity: 2 } // Rare (Piercing Rounds): 2 × 3000 = 6,000
          ],
          droneSlots: [],
          shipComponents: {}
        }]
    ...
    it('deducts calculated recovery cost instead of flat 500', () => {
      ...
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          shipId: starterPoolShipIds[0],
          decklist: [
            { id: 'OUT_THINK', quantity: 20 } // 20 Common (non-starter) = 20,000 × 0.5 = 10,000
          ],
          droneSlots: [],
          shipComponents: {}
        }]
    ...
    it('returns the calculated cost in the result', () => {
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          shipId: starterPoolShipIds[0],
          decklist: [
            { id: 'OUT_THINK', quantity: 40 } // 40 Common (non-starter) = 40,000 × 0.5 = 20,000
          ],
          droneSlots: [],
          shipComponents: {}
        }]
    ...
    it('returns calculated cost for a specific slot', () => {
      gameStateManager.getState.mockReturnValue({
        singlePlayerShipSlots: [{
          ...
          shipId: starterPoolShipIds[0],
          decklist: [
            { id: 'OUT_THINK', quantity: 10 } // 10 Common (non-starter) = 10,000 × 0.5 = 5,000
          ],
          droneSlots: [],
          shipComponents: {}
        }]
