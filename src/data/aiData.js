const aiPersonalities = [
  ...
  },
  {
    ...
    dronePool: ['Avenger', 'Devastator', 'Mammoth', 'Gladiator', 'Dart', 'Skirmisher', 'Behemoth', 'Vindicator', 'Sabot', 'Tempest'],
    shipComponents: {
      'BRIDGE_001': 'l',
      'DRONECONTROL_001': 'm',
      'POWERCELL_001': 'r'
    ...
    { id: 'FINISHING_VOLLEY_ENHANCED', quantity: 3 },
    { id: 'COMBAT_ENHANCEMENT_ENHANCED', quantity: 2 },
    { id: 'SHIELD_AMPLIFIER_ENHANCED', quantity: 2 },
    { id: 'SUNDERING_BEAM_ENHANCED', quantity: 2 },
    { id: 'NUKE_ENHANCED', quantity: 1 },
    { id: 'REBOOT_ENHANCED', quantity: 3 },
    { id: 'REACTIVATION_PROTOCOL_ENHANCED', quantity: 3 },
    { id: 'DESPERATE_MEASURES_ENHANCED', quantity: 3 },
    { id: 'DEPLOY_SHIELD_ARRAY_ENHANCED', quantity: 2 },
    { id: 'DEPLOY_PROXIMITY_MINE_ENHANCED', quantity: 3 },
    { id: 'PIERCING_ROUNDS_ENHANCED', quantity: 1 },
    { id: 'DEPLOY_JAMMERS_ENHANCED', quantity: 3 },
    { id: 'EMP_BURST_ENHANCED', quantity: 3 },
    { id: 'STASIS_FIELD_ENHANCED', quantity: 2 },
    { id: 'SENSOR_MALFUNCTION_ENHANCED', quantity: 3 }
    ]
  },
  {
