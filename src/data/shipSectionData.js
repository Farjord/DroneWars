...
const shipComponentCollection = [
...

  {
    ...
    stats: {
      ...
      damaged: { 'Draw': 5, 'Discard': 0 },
      critical: { 'Draw': 3, 'Discard': 0 },
    },
    middleLaneBonus: { 'Draw': 1, 'Discard': 0 },
    image: '/DroneWars/img/Bridge.png',
    ability: {
...

  {
    ...
    {
    id: 'CUBERNETIC_AUGMENTATION_COMMAND',
    type: 'Bridge',
    name: 'Cybernetic Augmentation Command',
    key: 'bridge', // Legacy key for backward compatibility
    rarity: 'Common',
    ...
    thresholds: { damaged: 5, critical: 0 },
    stats: {
      healthy: { 'Draw': 6, 'Discard': 0 },
      damaged: { 'Draw': 5, 'Discard': 0 },
      critical: { 'Draw': 4, 'Discard': 0 },
    },
    middleLaneBonus: { 'Draw': 1, 'Discard': 0 },
    image: '/DroneWars/img/Bridge.png',
    ability: {
...

  {
    ...
    {
    id: 'OVERLOADED_POWER_CELL',
    type: 'Power Cell',
    name: 'Overloaded Power Cell',
    key: 'powerCell', // Legacy key for backward compatibility
    rarity: 'Common',
    ...
    thresholds: { damaged: 5, critical: 0 },
    stats: {
      healthy: { 'Energy Per Turn': 12, 'Max Energy': 10, 'Shields Per Turn': 2 },
      damaged: { 'Energy Per Turn': 12, 'Max Energy': 10, 'Shields Per Turn': 1 },
      critical: { 'Energy Per Turn': 10, 'Max Energy': 8, 'Shields Per Turn': 0 },
    },
    middleLaneBonus: { 'Energy Per Turn': 2, 'Max Energy': 2, 'Shields Per Turn': 0 },
    image: '/DroneWars/img/Power_Cell.png',
    ability: {
...

  {
    ...
    stats: {
      ...
      critical: { 'Initial Deployment': 10, 'CPU Control Value': 8, 'Deployment Budget': 1 },
    },
  ...
  {
    id: 'HEAVY_DRONE_CONTROL_HUB',
    type: 'Drone Control Hub',
    name: 'Heavy Drone Control Hub',
    key: 'droneControlHub', // Legacy key for backward compatibility
    rarity: 'Common',
    ...
    thresholds: { damaged: 5, critical: 0 },
    stats: {
      healthy: { 'Initial Deployment': 16, 'CPU Control Value': 7, 'Deployment Budget': 6 },
      damaged: { 'Initial Deployment': 16, 'CPU Control Value': 7, 'Deployment Budget': 3 },
      critical: { 'Initial Deployment': 16, 'CPU Control Value': 7, 'Deployment Budget': 2 },
    },
    middleLaneBonus: {'Initial Deployment': 4, 'Deployment Budget': 4, 'CPU Control Value': 0 },
    image: '/DroneWars/img/Drone_Control_Hub.png',
    ability: {
